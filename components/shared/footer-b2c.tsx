      ...
      <div className="max-w-[1800px] mx-auto px-8 lg:px-12 py-16">
        <div className="grid lg:grid-cols-3 gap-12 mb-12">
          ...
          >
            ...
            <a
              href="/dataset"
              className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/10 hover:bg-blue-500/20 
                         text-blue-400 font-semibold rounded-lg border border-blue-500/20 
